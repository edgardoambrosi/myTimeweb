			...
			anomalie:function(i,f){
				...
				$.ajax({
				  ...
				  method: 'GET'	
					...
					var anomalieTable="<table style='border: 1px solid black;' id='anomalieTable'/>"
					$('#pannello-menu').append(anomalieTable);            
					$('#anomalieTable').append('<th style="border: 1px solid black;">GIORNO</th><th style="border: 1px solid black;">TIMBRATURE</th><th style="border: 1px solid black;">SELEZ</th>');
					...
					$.each(t,function(i,e){
						if ($(e).attr('vis')!="no"){
							...
							$('#anomalieTable').append('<tr><td style="border: 1px solid black;">'+d+'</td><td style="border: 1px solid black;">'+h+'</td><td style="border: 1px solid black;"><input type="checkbox"></td></tr>');
						}
					})
				});
			},
