...
Da linea di comando lanciare il seguente comando:
while true;do inotifywait -r -e modify,close_write nodejs_test_timbrature_logica.js && nodejs nodejs_test_timbrature_logica;done

Ogni volta si salva lo script questo viene eseguito.
*/
